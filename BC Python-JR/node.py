...
def get_node_ui():
    return send_from_directory('C:\cygwin64\home\Juan Riofrio', 'node.html')


@app.route('/network', methods =['GET'])
def get_network_ui():
    return send_from_directory('C:\cygwin64\home\Juan Riofrio', 'network.html')
...
def broadcast_transaction():
    ...
    if success:
        ...
        response = {
            'messege': 'Creating a transaction failed.'
		}
        return jsonify(response), 500
